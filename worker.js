...
async function shortenWithDefaultAPI(chatId, url) {
  const apiUrl = `https://tinyurl.com/api/short?url=${encodeURIComponent(url)}`;
...
// Made by https://t.me/Ashlynn_Repository
async function shortenWithDefaultAPI(chatId, url) {
  const apiUrl = `https://shortmklinks.blogspot.com/api/short?url=${encodeURIComponent(url)}`;
...
// Made by https://t.me/Ashlynn_Repository
    return null;const TOKEN = '7531498113:AAGI-IFY6QPwhGM5UdHpzDwgjZPXNlnGHUw'; // Replace with your BotFather token
const WEBHOOK = '/endpoint';
// Made by https://t.me/Ashlynn_Repository
addEventListener('fetch', event => {
  const url = new URL(event.request.url);
...
// Made by https://t.me/Ashlynn_Repository
    ...
    coconst TOKEN = '7531498113:AAGI-IFY6QPwhGM5UdHpzDwgjZPXNlnGHUw'; // Replace with your BotFather token
const WEBHOOK = '/endpoint';
// Made by https://t.me/Ashlynn_Repository
addEventListener('fetch', event => {
  const url = new URL(event.request.url);
...
// Made by https://t.me/Ashlynn_Repository
nsole.error("Error resolving URL:", error);
    return null;
  }
}
// Made by https://t.me/Ashlynn_Repository
